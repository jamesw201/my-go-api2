...
func (m *Site) validateDomains(formats strfmt.Registry) error {
...
func (m *Site) validateEnvironments(formats strfmt.Registry) error {
...
func (m *Site) contextValidateDomains(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Site) contextValidateEnvironments(ctx context.Context, formats strfmt.Registry) error {
